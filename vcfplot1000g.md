...
##   Character matrix gt rows: 3892
##   Character matrix gt cols: 2543
##   skip: 0
##   nrows: 3892
##   row_num: 0
## Processed variant 1000Processed variant 2000Processed variant 3000Processed variant: 3892
...
```
## Warning in vcfR2genlight(vcf, n.cores = 1): Found 275 loci with more than two alleles.
## Objects of class genlight only support loci with two alleles.
## 275 loci will be omitted from the genlight object.
```
Functions
...
![](vcfplot1000g_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](vcfplot1000g_files/figure-html/unnamed-chunk-7-1.png)<!-- -->

```r
glPlot(aa.genlight)
```

![](vcfplot1000g_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
